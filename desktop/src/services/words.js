...
export const wordsApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    responseWord: builder.mutation({
      query: ({ id, ...payload}) => ({
        url: `words/${id}/response`,
        method: 'PUT',
        body: payload,
        headers: {
            'Content-type': 'application/json; charset=UTF-8',
...
export const { useCreateWordMutation, useGetWordsQuery, useUpdateWordMutation, useDeleteWordMutation, useResponseWordMutation } = wordsApi
